...
type AgentMoney struct {
	...
	OrderNo    string          `gorm:"column:order_no;size:30;not null" json:"order_no"`                               // 平台订单编码
	MOrderNo   string          `gorm:"column:m_order_no;size:30;not null" json:"m_order_no"`                           // 商户订单编码
