...
type MoneyLog struct {
	...
	OrderNo     string          `gorm:"column:order_no;size:50;not null" json:"order_no"`                  // 订单编码
	...
	OldBalance  decimal.Decimal `gorm:"column:old_balance;type:decimal(13,2);not null" json:"old_balance"` // 原始余额
	Balance     decimal.Decimal `gorm:"column:balance;type:decimal(13,2);not null" json:"balance"`         // 变化后余额
	CreateTime  time.Time       `gorm:"column:create_time;not null" json:"create_time"`                    // 时间戳
}
