...
type PayUpstream struct {
	...
	SuccessRate    float64 `gorm:"column:success_rate;type:double(5,2);default:100.00" json:"successRate"` // 成功率
	...
	PayingMoney    float64 `gorm:"column:paying_money;type:decimal(16,2);default:0.00" json:"payingMoney"` // 当天交易金额
	MinMoney       float64 `gorm:"column:min_money;type:decimal(15,2);default:0.00" json:"minMoney"`       // 单笔最小交易额
	MaxMoney       float64 `gorm:"column:max_money;type:decimal(15,2);default:0.00" json:"maxMoney"`       // 单笔最大交易额
